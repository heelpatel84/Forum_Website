...
// Check if the query returned any rows
        if (mysqli_num_rows($result2) > 0) {
            ...
            echo '<div class="media my-3">
                <img src="img/man.png" width="54px" class="mr-3" alt="...">
                <div class="media-body">
                <p class="font-weight-bold my-0">'. $row2['user_email'] .' at '. $comment_time. '</p> '. $content . '
                </div>
            </div>';
        } else {
            // Handle the case where no user email is found
            echo '<div class="media my-3">
                <img src="img/man.png" width="54px" class="mr-3" alt="...">
                <div class="media-body">
                <p class="font-weight-bold my-0">User not found at '. $comment_time. '</p> '. $content . '
                </div>
            </div>';
        }
